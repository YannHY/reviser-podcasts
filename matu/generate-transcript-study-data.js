...
<body class="quiz-page matu-page">
  ...
  <script src="../../shared.js?v=20260523-1"></script>
  <script src="../../fr/quiz/quiz.js?v=20260428-1"></script>
  <script src="../../header.js?v=20260523-1" defer></script>
  <script>const yearEl = document.getElementById('current-year'); if (yearEl) yearEl.textContent = new Date().getFullYear();</script>
</body>
</html>
`;
}
